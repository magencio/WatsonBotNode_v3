...
- It uses [WATSON Assistant](https://console.bluemix.net/docs/services/conversation/getting-started.html) for Natural Language Processing and Conversation Flow management. For this sample I used the "Customer Service - Sample" workspace that IBM Watson Assistant provides and added an action to one of the dialogs just for testing purposes. You can find the exported .json file of that workspace in the ./watson folder.
